...
export const ERROR_MESSAGES = {
    ...
    AUTHENTICATION_FAILED: "Authentication failed - please check your Google credentials or GEMINI_API_KEY",
    GEMINI_NOT_FOUND: "Gemini CLI not found - please install with 'brew install gemini-cli' or 'npm install -g @google/gemini-cli'",
    TOOL_NOT_FOUND: "not found in registry",
    NO_PROMPT_PROVIDED: "Please provide a prompt for Gemini. Be specific and direct in your request.",
